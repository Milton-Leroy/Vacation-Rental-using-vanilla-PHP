...
<?php require_once('php/connection.php'); ?>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('public/images/image_2.jpg');">
    	...
    	<div class="container">
          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(public/images/services-1.jpg);"></div>
    ...
    <section class="ftco-section bg-light">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-6 wrap-about">
						<div class="img img-2 mb-4" style="background-image: url(public/images/image_2.jpg);">
						</div>
		...
		<section class="ftco-intro" style="background-image: url(public/images/image_2.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
